...
Blockly.Xml.blockToDom = function (a, b) {
    ...
    a.isEditable() || c.setAttribute("editable",
        !1);
...
Blockly.WorkspaceCommentSvg.prototype.getBoundingRectangle = function () {
    var a = this.getRelativeToSurfaceXY(), b = this.getHeightWidth(), c = a.y, d = a.y + b.height;
    if (this.RTL) {
        var e = a.x - b.width;
        a = a.x
...
Blockly.WorkspaceCommentSvg.prototype.addDeleteDom_ = function () {
    ...
    Blockly.utils.dom.createSvgElement("line", {
        x1: "5", y1: "5",
        x2: "10", y2: "10", stroke: "#fff", "stroke-width": "2"
    }, this.deleteGroup_)
};
...
Blockly.FieldAngle.prototype.updateGraph_ = function () {
    if (this.gauge_) {
        var a = Number(this.getText()) + Blockly.FieldAngle.OFFSET, b = Blockly.utils.math.toRadians(a % 360);
        ...
        if (!isNaN(b)) {
            var e = Blockly.utils.math.toRadians(Blockly.FieldAngle.OFFSET),
                f = Math.cos(e) * Blockly.FieldAngle.RADIUS, g = Math.sin(e) * -Blockly.FieldAngle.RADIUS;
